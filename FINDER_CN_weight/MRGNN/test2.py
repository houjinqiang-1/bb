...
#                      torch.save(graphsage[k_i].state_dict(), './ablation/celegans/bitwise/_{}_{}.pkl'.format(best_epoch,k_i))
#                  best_test = test_Auc
#                  patience = 0
#             else:
#                  patience = patience + 1
...
#                  break
#             files = glob.glob('./ablation/celegans/bitwise/*.pkl')
#             for file in files:
...
#             os.remove(file)
    for k_j in range(lay_num):
        graphsage[k_j].load_state_dict(torch.load('./ablation/celegans/bitwise/_{}_{}.pkl'.format(301,k_j)))#best_epoch
    ...
    with open("./ablation/celegans/bitwise/celegans-attention-bitwise.pkl", "wb") as f:
