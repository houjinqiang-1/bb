...
if __name__ == "__main__":
    ...
    # cost.append(score_std) 
            cost.append(score)    
            file_path1 = "../../results/HDA/cost/"+ "cost_" + dataname + "_23_1.txt"
            with open(file_path1, 'w') as file:
                for c in cost:
                    file.write('%.8f\n' % c)
            file_path2 = "../../results/HDA/cost/MaxCCList_Strategy_"+ dataname + "_23_1.txt"
            ...
            file_path3 = "../../results/HDA/cost/"+ "remove_nodes" + dataname + "_23_1.txt"
