...
def critical_number(G1, G2, N, ND_ori,w1,w2):
    ...
    while ND_temp != 1:
    #while num != 1:
        deleteNode = delnode(G1, G2, w1, w2)
...
if __name__ == "__main__":
    ...
    # cost.append(score_mean) #把score加到记录cost的文件里 
    # cost.append(score_std) 
            cost.append(score)    
            file_path1 = "../../results/HDA/cost/"+ "cost_" + dataname + "_23_2.txt"
            with open(file_path1, 'w') as file:
                for c in cost:
                    file.write('%.8f\n' % c)
            file_path2 = "../../results/HDA/cost/MaxCCList_Strategy_"+ dataname + "_23_2.txt"
            ...
            file_path3 = "../../results/HDA/cost/"+ "remove_nodes" + dataname + "_23_2.txt"
