...
from FINDER.FINDER_torch import FINDER1
# Hyper Parameters:
...
class FINDER:
    def __init__(self):
        ...
        self.FINDER1.LoadModel('/home/gww/yangchen/code/FINDER/models/nrange_30_50_iter_206700.ckpt')
    ...
    def calc_loss(self, q_pred, cur_message_layer) :
        ...
        with open('loss_30-50_weightq_mlp.txt', 'a') as f:
    ...
    def GetSolution(self, gid, step=1):
        ...
        while (not self.test_env.isTerminal()):              
            ...
            list_pred1 = self.FINDER1.PredictWithCurrentQNet(g_list, [self.test_env.action_list], [self.test_env.remove_edge])
            ...
            if len(finite_indices) > protect_number:
                ...
                sorted_indices1 = np.argsort(-list_pred1[0][finite_indices])           
                protect_index = finite_indices[sorted_indices1[:protect_number]]
