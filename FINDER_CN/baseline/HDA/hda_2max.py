...
if __name__ == "__main__":
    ...
    for j in range(len(dataname_list)):
        ...
        file_path1 = "../../../results/HDA/none_cost/"+ "remove_nodes" + dataname + "_%s%s_1.txt"%(layer_list[j][0],layer_list[j][1])
        with open(file_path1, 'w') as file:
            for c in remove_nodes:
                file.write(str(c) + '\n')
        file_path2 = "../../../results/HDA/none_cost/MaxCCList_Strategy_"+ dataname + "_%s%s_1.txt"%(layer_list[j][0],layer_list[j][1])
