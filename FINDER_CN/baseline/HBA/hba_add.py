...
if __name__ == "__main__":
    datapath = '../../../data/'
    dataname = 'CKM-Physicians-Innovation_multiplex'
    #N = node_num[dataname]
    N = 246
    ...
    for i in tqdm(range(n)):
        ...
        score += temp_score
    avg_score = score/n
    print('HDA score:',avg_score)
    print("solution time", t2-t1)  
    file_path1 = "../../../results/HBA/none_cost/"+ "remove_nodes" + dataname + "_12_2.txt"
    with open(file_path1, 'w') as file:
        for c in remove_nodes:
            file.write(str(c) + '\n')
    file_path2 = "../../../results/HBA/none_cost/MaxCCList_Strategy_"+ dataname + "_12_2.txt"
