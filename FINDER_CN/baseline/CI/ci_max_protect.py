...
if __name__ == "__main__":
    ...
    for j in range(len(dataname_list)):
        ...
        file_path2 = "../../../results/CI/protect/MaxCCList_Strategy_"+ dataname + "_%s%s_1.txt"%(layer_list[j][0],layer_list[j][1])
