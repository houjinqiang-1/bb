...
if __name__ == "__main__":
    datapath = '../../../data/'
    dataname = 'Krackhardt-High-Tech_multiplex'
    #N = node_num[dataname]
    N = 21
    ...
    file_path1 = "../../../results/HCA/none_cost/"+ "remove_nodes" + dataname + "_23_1.txt"
    with open(file_path1, 'w') as file:
        for c in remove_nodes:
            file.write(str(c) + '\n')
    file_path2 = "../../../results/HCA/none_cost/MaxCCList_Strategy_"+ dataname + "_23_1.txt"
